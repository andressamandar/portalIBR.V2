...
import {LouvorEscalado,LouvoresEscalaService} from '../../../../core/services/louvores-escala.service';
...
export class MinhaEscalaComponent
          ...
          forkJoin(
            ...
            .subscribe({
              ...
              error: erro => {
                ...
                const mensagem =
                  erro?.error?.message ??
                  'Não foi possível carregar os louvores das escalas.';
  ...
  baixarPdf(): void {
    ...
    try {
      ...
      doc.text(
        'Minha Escala - Ministério de Louvor',
        14,
        y
      );
          ...
          if (
            ...
            item.louvores.forEach(
              (
                ...
                const texto =
                  `${louvorIndice + 1}. ${louvor.louvor}${tom}`;
